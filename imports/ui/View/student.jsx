  ...
  render() {
              ...
              onClick={() => {
                Meteor.call("delete.student", record._id, (err, res) => {
                  if (err) {
                    ...
                    message.success(
                      "Student & all related records are deleted!"
                    );
                  }
                });
              }}
    ...
    return (
      ...
      >
        ...
        <MDBModal isOpen={this.state.modal3}>
          <MDBModalHeader>Select Class</MDBModalHeader>
          <MDBModalBody>
            <Select
              mode="multiple"
              labelInValue
          ...
          <MDBModalFooter>
            ...
            <MDBBtn color="primary" onClick={() => this.addStudents()}>
              Add
            </MDBBtn>
          </MDBModalFooter>
        </MDBModal>
