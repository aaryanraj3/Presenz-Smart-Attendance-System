...
export class listPatients extends Component {
  ...
  getRole = (arr) => {
    if (arr[0] == "admin") {
      return (
        <MDBContainer>
          <MDBBadge color="default">Admin</MDBBadge>
        </MDBContainer>
      );
        ...
        render: (text, record) => (
          <span>
            <MDBBtn
              ...
              color="info"
              size="sm"
              onClick={() => this.setState({ modal: true, userId: record._id })}
            >
              Reset Password
            </MDBBtn>
            <MDBBtn
      ...
      >
        ...
        >
          ...
          <MDBModalFooter>
            ...
            <MDBBtn color="primary" onClick={() => this.resetUserPassword()}>
              Save changes
            </MDBBtn>
          </MDBModalFooter>
        </MDBModal>
        <MDBModal
          ...
          toggle={() =>
            this.setState({ modal2: false, userRemoved: "", username: "" })
          }
        >
          <MDBModalHeader toggle={() => this.setState({ modal: false })}>
            Remove User
          ...
          <MDBModalBody>
            <p>
              {" "}
              Are you sure you want to remove this user {this.state.username}?
              Please note that this action is <strong>IRREVERSIBLE</strong> and
              cannot be <strong>undone</strong>
            </p>{" "}
          </MDBModalBody>
          <MDBModalFooter>
            <MDBBtn
            ...
            <MDBBtn color="primary" onClick={() => this.removeUser()}>
              Confirm
            </MDBBtn>
          </MDBModalFooter>
        </MDBModal>
